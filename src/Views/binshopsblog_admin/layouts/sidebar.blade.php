    ...
    <li class="list-group-item list-group-color justify-content-between lh-condensed">
        <div>
            <h6 class="my-0"><a href="{{ route('binshopsblog.admin.comments.index') }}">Comments</a>
                ...
                <span class="text-muted">(<?php
                    $commentCount = \BinshopsBlog\Models\BinshopsComment::withoutGlobalScopes()
                    ->with('post')->whereHas('post',
                    function($query){ 
            ...
            <div class="list-group ">
                ...
                <?php $comment_approval_count = \BinshopsBlog\Models\BinshopsComment::withoutGlobalScopes()
                                            ->with('post')->whereHas('post',
                                            function($query){ 
                                                return $query->where('user_id', \Auth::user()->id);
                                            })
    ...
    <li class="list-group-item list-group-color  justify-content-between lh-condensed">
        <div>
            <h6 class="my-0"><a href="{{ route('binshopsblog.admin.categories.index') }}">Categories</a>
                <span class="text-muted">(<?php
                    $postCount = \BinshopsBlog\Models\BinshopsCategory::where('created_by', \Auth::user()->id)
                                ->count();
